package NilaiMataKuliah;

    import java.util.ArrayList;
    import java.util.Scanner;

class NilaiMataKuliah1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Masukkan nama anda :tia ");
        String namaMahasiswa = inputan.nextLine();

        System.out.print("Masukkan semester :1 ");
        ...
        System.out.println("Semeter :1 " + semester);
        System.out.println("=======================================================================================");
        ...
        System.out.println("IP. Semester :3,33 " + rataRata);
